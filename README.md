...
To read the physical memory space, use [`phys::Reader`](https://docs.rs/kdmp-parser/0.8.0/kdmp_parser/phys/struct.Reader.html) and [`virt::Reader`](https://docs.rs/kdmp-parser/0.8.0/kdmp_parser/struct.Reader.html#method.read) to read the virtual memory space.
